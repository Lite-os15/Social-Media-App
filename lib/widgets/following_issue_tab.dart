...
class FollowingIssueTab extends StatefulWidget {
  const FollowingIssueTab({Key? key}) : super(key: key);

  @override
  State<FollowingIssueTab> createState() =>
      FollowingIssueTabState();
}

class FollowingIssueTabState extends State<FollowingIssueTab>
